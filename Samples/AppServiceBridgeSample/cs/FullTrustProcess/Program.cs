...
namespace FullTrustProcess
{
    class Program
    {
        ...
        static void ThreadProc()
        {
            ...
            operation.Completed += new AsyncOperationCompletedHandler<AppServiceConnectionStatus>(ConnectionOpened);
            if (operation.ErrorCode != null)
                Console.WriteLine(operation.ErrorCode.ToString());
        }

        /// <summary>
        /// Handles connection status
        /// </summary>
        private static void ConnectionOpened(IAsyncOperation<AppServiceConnectionStatus> asyncStatus, AsyncStatus unused)
        {
            AppServiceConnectionStatus status = asyncStatus.GetResults();
            switch (status)
            {
