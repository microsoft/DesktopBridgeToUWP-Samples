...
void App::OnShareTargetActivated(Windows::ApplicationModel::Activation::ShareTargetActivatedEventArgs ^e)
{
	Frame ^rootFrame = ref new Frame();
	rootFrame->Navigate(TypeName(MainPage::typeid), e->ShareOperation);
