...
{
    /// <summary>
    /// This class contains a copied and stripped down version of the C++ COM API
    ///  used to instantiate out-of-process COM object.
    /// </summary>
    internal class CppComApi
    {
        [DllImport("ole32.dll")]
...
} // namespace Background1WinMainComSample_CS
